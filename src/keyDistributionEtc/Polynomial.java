...
public class Polynomial {
    ...
    public static void main(String[] args) { 
        ...
        Polynomial v    = p.compose(q);
        Polynomial u    = p.minus(p);

       // System.out.print("zero(x)     = " + zero);
      // System.out.print("p(x)        = " + p);
      //  System.out.print("q(x)        = " + q);
      // System.out.print("p(x) + q(x) = " + r);
      //  System.out.print("p(x) * q(x) = " + s);
      //  System.out.print("p(q(x))     = " + v);
      //  System.out.print("p(x) - p(x) = " + u);
      //  System.out.print("0 - p(x)    = " + zero.minus(p));
      //  System.out.print("p(3)        = " + p.evaluate(3));
      //  System.out.print("p'(x)       = " + p.differentiate());
      //  System.out.print("p''(x)      = " + p.differentiate().differentiate());
        
        
        ////////////////////////////////////////////////////////////////// Question 5 trial
        
	    int n_participants = 5; //number of participants
        int t = 3;
        int secret = 44;
        ...
        int degree = 1;
        ArrayList<Polynomial> cars = new ArrayList<Polynomial>();
     	for (int i = 0; i < t-1; i++) {
     		cars.add(new Polynomial(ThreadLocalRandom.current().nextInt(1, 100+1), degree));
     		degree++;
     	}
     	cars.add(0, secret_poly);
     	//System.out.print(cars);
     	
        Polynomial base = new Polynomial(0, 0);
     	for (int j = 0; j < cars.size(); j++) { 
         	base = base.plus(cars.get(j));
     	}
     	System.out.print(base);
     	
     	////////////////////////////////////////////////////////// Question 5 manually get polynomial 
	   
     	//int n_participants = 5; //number of participants
       // int t = 3;
       // int secret = 44; //this is the secret value

        //EDIT THIS PART FOR POLYNOMIAL DEGREES
        //create a polynomial of degree t-1, starting with secret as degree 0
        //the coefficients are randomly chosen, between 1 and 100
       //Polynomial x0 = new Polynomial(secret, 0); //secret coefficient w/ degree 0
       //Polynomial x1 = new Polynomial(ThreadLocalRandom.current().nextInt(1, 100+1), 1);
       //Polynomial x2 = new Polynomial(ThreadLocalRandom.current().nextInt(1, 100+1), 2); //stopped at t-1
       // Polynomial formed_poly = x0.plus(x1).plus(x2);
        //System.out.print(formed_poly + "\n"); //print out the formed polynomial of degree t-1

        
     	//this is how we get the n number of points based on how many paritipants there are
     	//for (int i = 1; i < n_participants+1; i++) {
        //	System.out.println( + i + " " + formed_poly.evaluate(i));
        //} 
	}
